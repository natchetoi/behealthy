...
/**
 * @file
 * Contains \Drupal\be_healthy_main\Controller\FrontendApiExamplePageController.
 */

namespace Drupal\be_healthy_main\Controller;
 ...
 */
class CurrentRelease extends ControllerBase {

  /**
   * Constructs a page with descriptive content.
   *
   * Our router maps this method to the path 'school/be_healthy_main'.
   */
  public function page() {
    ...
    $frontend_api_example_simple_routing_link = $this->l($this->t('Simple Routing'), Url::fromRoute('be_healthy_main.response'));
    $frontend_api_example_simple_routing_json_link = $this->l($this->t('Routing Json '), Url::fromRoute('be_healthy_main.response_json'));
    $frontend_api_example_simple_routing_redirect_link = $this->l($this->t('Routing Redirect'), Url::fromRoute('be_healthy_main.response_redirect'));
    // Now the arguments page.
